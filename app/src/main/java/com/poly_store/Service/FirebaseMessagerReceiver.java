package com.poly_store.Service;
...
import com.poly_store.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body){
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_baseline_shopping_basket_24);
        return remoteViews;
    }
}
